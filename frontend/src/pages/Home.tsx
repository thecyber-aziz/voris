        ...
        <footer className="border-t border-emerald-200/50 dark:border-emerald-800/30 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <LogoWithText />
              <span className="text-sm font-medium text-black dark:text-blak">© 2026 Voris. All rights reserved.</span>
            </div>
            <div className="flex gap-6 items-center">
              <a href="#" className="text-sm text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Github</a>
              <a href="#" className="text-sm text-slate-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Linkedin</a>
